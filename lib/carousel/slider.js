...
var Slider = /*#__PURE__*/function (_Component) {
  ...
  function Slider(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "init", function () {
      ...
      settings = _objectSpread(_objectSpread({}, _types.defaultProps), _this.props); // force showing one slide and scrolling by one if the fade mode is on
  ...
  _createClass(Slider, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var newPrevProps = _objectSpread(_objectSpread({}, prevProps), {}, {
        children: []
      });
    ...
    value: function render() {
      ...
      var spec = _objectSpread(_objectSpread({}, settings), this.prop);
      ...
      if (settings.arrows) {
        prevArrow = /*#__PURE__*/_react["default"].createElement(_arrows.PrevArrow, _extends({}, arrowProps, {
        ...
        nextArrow = /*#__PURE__*/_react["default"].createElement(_arrows.NextArrow, _extends({}, arrowProps, {
          clickHandler: function clickHandler(options) {
            _this2.beforeChangeTrigger = false;
            _this2.scrollType = {
              type: 'arrows',
      ...
      if (settings.dots === true && this.items) {
        if (this.items.length >= settings.slidesToShow) {
          ...
          dots = /*#__PURE__*/_react["default"].createElement(_dots["default"], dotProps);
        }
      }
      ...
      var component = /*#__PURE__*/_react["default"].createElement(_react.Fragment, null, /*#__PURE__*/_react["default"].createElement("div", {
        ref: function ref(e) {
      ...
      }, !settings.unslick && judge ? prevArrow : '', /*#__PURE__*/_react["default"].createElement("div", {
        style: {
